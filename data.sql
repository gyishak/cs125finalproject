...
INSERT INTO Event (ID, Type, Notes) VALUES
  (1, 'Youth Group Night', 'Weekly meeting with games, worship, and small groups.'),
  (2, 'Service Project',   'Volunteering at the local food bank.'),
  (3, 'Retreat',           'Weekend retreat at the mountain camp.');
